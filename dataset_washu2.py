...
train_transform = A.Compose([
    ...
    A.ElasticTransform(alpha=1, sigma=120, alpha_affine=5, p=0.5),
    A.GridDistortion(distort_limit=0.01, p=0.5),
    
    # Intensity-related augmentations
    A.GaussNoise(mean_range=(-0.1, 0.1), std_range=(0.001, 0.05), p=0.9),  # Slightly reduced noise
...
train_transform = A.Compose([
    ...
    A.RandomResizedCrop(size=(384, 384), scale=(0.5, 1.0), ratio=(0.75, 1.33), p=1.0),
