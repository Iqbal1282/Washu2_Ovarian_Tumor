...
class BinaryClassification(pl.LightningModule):
    def __init__(self, input_dim=8192*2, num_classes = 1,  lr=1e-3, weight_decay=1e-5, encoder_weight_path = None, radiomics = False, radiomics_dim = 463):
        ...
        sdf_model_path = r"checkpoints\deeplabv3_sdf_randomcrop\model_20250711_113651\epoch_49" #
        #"./checkpoints/deeplabv3/model_20250620_211018/epoch_16" #r"checkpoints\deeplabv3_sdf_randomcrop\model_20250711_113651\epoch_49" #
